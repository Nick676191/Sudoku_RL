...
# new_starting_hard_puzzle = starting_hard_puzzle.copy()
# # print(starting_hard_puzzle)

starting_hard_puzzle = np.array([
    [100, 100, 6, 100, 100, 100, 100, 100, 1],
    [100, 7, 100, 100, 6, 100, 100, 5, 100],
    [8, 100, 100, 1, 100, 3, 2, 100, 100],
    [100, 100, 5, 100, 4, 100, 8, 100, 100],
    [100, 4, 100, 7, 100, 2, 100, 9, 100],
    [100, 100, 8, 100, 1, 100, 7, 100, 100],
    [100, 100, 1, 2, 100, 5, 100, 100, 3],
    [100, 6, 100, 100, 7, 100, 100, 8, 100],
    [2, 100, 100, 100, 100, 100, 4, 100, 100]
])
new_starting_hard_puzzle = starting_hard_puzzle.copy()
...
while puzzle_unfinished:
    ...
    if finalPuzzleChecker(totalPresentDict):
        print(f"Initial sudoku puzzle\n{new_starting_hard_puzzle}\n")
